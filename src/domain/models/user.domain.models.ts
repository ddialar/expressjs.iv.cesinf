...
export type NewUserDomainModel = Pick<UserDomainModel, 'username' | 'password' | 'email'>
...
export type AuthenticatedUserDomainModel = Pick<UserDomainModel, 'token' | 'username' | 'avatar'>
