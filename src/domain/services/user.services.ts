...
import { UserDomainModel, NewUserDomainModel, UserProfileDomainModel, NewUserProfileDomainModel } from '../models'
...
export const createUser = async (newUserData: NewUserDomainModel): Promise<void> => {
  await checkIfNewUserAlreadyExists(newUserData.username)
